...
export class DotsBoard {
  private _dotsCount: number
  private _centralCircleRadius: number
  private canvas: HTMLCanvasElement
  private ctx: CanvasRenderingContext2D
  private raysLength: number
  ...
  constructor(canvasSelector: string, dotsCount: number, centralCircleRadius: number, mouseEvent?: boolean, filledDots?: boolean) {
  ...
  private animate = () => {
    ...
    // Center cycle
    this.ctx.fillStyle = 'rgb(38, 38, 39)'
    this.ctx.strokeStyle = 'rgba(194, 35, 88, 0.9)'
    ...
    gradient.addColorStop(0, 'rgba(168, 147, 214, 0.5)')
    gradient.addColorStop(1, 'rgba(194, 35, 88, 0.1)')
